      ...
      <div className="settings">
        ...
        <div className="settings__data">
          ...
          <div className="level">
            ...
            <select value = {level} name="level" id="level" className="level-select"onChange={(e) => {
          ...
          <div className="reset"> best score : 
          <button className="show-best-score" onClick={showBestScore}>show</button>
          <BestScore/>
          </div>
        </div>
      </div>
